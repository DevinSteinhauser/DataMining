...
```{r}
# Finding Complements
arules::inspect(subset(rules, by='lift', subset=items %ain% c("whole milk", "yogurt") & confidence>0.5))
```
...
```{r}
# Finding Substitutes
arules::inspect(subset(rules, by='lift', subset=lhs %pin% "whole milk" & rhs %in% "soda" & confidence>0.1))
```
