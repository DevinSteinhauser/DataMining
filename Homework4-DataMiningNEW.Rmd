...
liquorrules_lift <- sort(liquorrules, by='lift', decreasing=TRUE)
arules::inspect(head(liquorrules_lift))
...
bakingrules_lift <- sort(bakingrules, by='lift', decreasing=TRUE)
arules::inspect(head(bakingrules_lift))
...
frozenpotatorules_lift <- sort(frozenpotatorules, by='lift', decreasing=TRUE)
arules::inspect(head(frozenpotatorules_lift))
